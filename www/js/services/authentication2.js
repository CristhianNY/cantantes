...
app.service('UserService', function (FIREBASE_URL,
	...
	var self = {
		...
		loadUser: function () {
			...
			var currentUserId = $localstorage.get('cantantes-user', null);
		 ...
		 */
		logoutUser: function () {
			$localstorage.set('cantantes-user', null);
			self.current = {};
		},
		/*
		 Login the user
											...
											.then(function (authData) {
												...
												usersRef.child(authData.uid)
													...
													function (error, committed) {
														...
														//
														$localstorage.set('cantantes-user', authData.uid);
